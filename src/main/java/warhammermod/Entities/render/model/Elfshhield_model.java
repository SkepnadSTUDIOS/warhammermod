...
public class Elfshhield_model extends ModelShield {
    ...
    public Elfshhield_model()
    {
        ...
        this.plate.addBox(-6F, -11.0F, -2.0F, 7, 19, 1, 0.0F);
        this.plate2 = new ModelRenderer(this,0,0);
        this.plate2.addBox(1F,-8F,-2.0F,4,16,1,0.0F);
        ...
        this.plate8.addBox(1F,-11F,-2.0F,1,1,1,0.0F);
        this.plate7.addBox(4F,-9F,-2.0F,1,1,1,0.0F);
