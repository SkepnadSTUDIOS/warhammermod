...
public class EntityAIDPlay extends EntityAIBase
{
    ...
    public EntityAIDPlay(EntityDwarf villagerIn, double speedIn)
    {
    ...
    public boolean shouldExecute()
    {
        ...
        {
            List<EntityDwarf> list = this.villager.world.<EntityDwarf>getEntitiesWithinAABB(EntityDwarf.class, this.villager.getEntityBoundingBox().grow(6.0D, 3.0D, 6.0D));
            double d0 = Double.MAX_VALUE;

            for (EntityDwarf entityvillager : list)
            {
