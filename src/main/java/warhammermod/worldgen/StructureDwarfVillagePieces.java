...
public class StructureDwarfVillagePieces{
    ...
    public static void registerVillagePieces()
    {
        ...
        MapGenStructureIO.registerStructureComponent(StructureDwarfVillagePieces.Hall.class, "ViPH");
        MapGenStructureIO.registerStructureComponent(StructureDwarfVillagePieces.House4Garden.class, "ViSH");
        MapGenStructureIO.registerStructureComponent(StructureDwarfVillagePieces.WoodHut.class, "ViSmH");
        MapGenStructureIO.registerStructureComponent(StructureDwarfVillagePieces.Church.class, "ViST");
        MapGenStructureIO.registerStructureComponent(StructureDwarfVillagePieces.Forge.class, "ViS");
        MapGenStructureIO.registerStructureComponent(StructureDwarfVillagePieces.Start.class, "ViStart");
        MapGenStructureIO.registerStructureComponent(StructureDwarfVillagePieces.Path.class, "ViSR");
        MapGenStructureIO.registerStructureComponent(StructureDwarfVillagePieces.House3.class, "ViTRH");
        MapGenStructureIO.registerStructureComponent(StructureDwarfVillagePieces.Well.class, "ViW");
    }

    public static List<StructureDwarfVillagePieces.PieceWeight> getStructureVillageWeightedPieceList(Random random, int size)
    {
        ...
        list.add(new StructureDwarfVillagePieces.PieceWeight(StructureDwarfVillagePieces.Field2.class, 3, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
        list.add(new StructureDwarfVillagePieces.PieceWeight(StructureDwarfVillagePieces.Forge.class, 5, MathHelper.getInt(random, 0, 2 + size)));
        list.add(new StructureDwarfVillagePieces.PieceWeight(StructureDwarfVillagePieces.House3.class, 8, MathHelper.getInt(random, 0 + size, 3 + size * 2)));
        Iterator<StructureDwarfVillagePieces.PieceWeight> iterator = list.iterator();
    ...
    {
        public Class <? extends StructureDwarfVillagePieces.Village > villagePieceClass;
        public final int villagePieceWeight;
        public int villagePiecesSpawned;
        public int villagePiecesLimit;

        public PieceWeight(Class <? extends StructureDwarfVillagePieces.Village > p_i2098_1_, int p_i2098_2_, int p_i2098_3_)
        {
    ...
    private static int updatePieceWeight(List<StructureDwarfVillagePieces.PieceWeight> p_75079_0_)
    {
        boolean flag = false;
        int i = 0;

        for (StructureDwarfVillagePieces.PieceWeight structureDwarfvillagepieces$pieceweight : p_75079_0_)
        {
            if (structureDwarfvillagepieces$pieceweight.villagePiecesLimit > 0 && structureDwarfvillagepieces$pieceweight.villagePiecesSpawned < structureDwarfvillagepieces$pieceweight.villagePiecesLimit)
            {
                flag = true;
            }

            i += structureDwarfvillagepieces$pieceweight.villagePieceWeight;
        }
    ...
    public abstract static class Village extends StructureComponent{
        ...
        protected Village(StructureDwarfVillagePieces.Start start, int type)
        {
            super(type);
         ...
         */
        @Nullable
        protected StructureComponent getNextComponentNN(StructureDwarfVillagePieces.Start start, List<StructureComponent> structureComponents, Random rand, int p_74891_4_, int p_74891_5_)
        {
            ...
            if (enumfacing != null)
            {
                switch (enumfacing)
                {
                    case NORTH:
                    default:
                        return StructureDwarfVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                    case SOUTH:
                        return StructureDwarfVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                    case WEST:
                        return StructureDwarfVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    case EAST:
                        return StructureDwarfVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                }
            }
        ...
        @Nullable
        protected StructureComponent getNextComponentPP(StructureDwarfVillagePieces.Start start, List<StructureComponent> structureComponents, Random rand, int p_74894_4_, int p_74894_5_)
        {
            EnumFacing enumfacing = this.getCoordBaseMode();
            ...
            if (enumfacing != null)
            {
                switch (enumfacing)
                {
                    case NORTH:
                    default:
                        return StructureDwarfVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                    case SOUTH:
                        return StructureDwarfVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                    case WEST:
                        return StructureDwarfVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    case EAST:
                        return StructureDwarfVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                }
            }
        ...
        protected void spawnVillagers(World worldIn, StructureBoundingBox structurebb, int x, int y, int z, int count)
        {
            if (this.villagersSpawned < count)
            {
                for (int i = this.villagersSpawned; i < count; ++i)
                {
                    ...
                    {
                        EntityDwarf entityvillager = new EntityDwarf(worldIn);
                        entityvillager.setLocationAndAngles((double)j + 0.5D, (double)k, (double)l + 0.5D, 0.0F, 0.0F);
                        entityvillager.setRandomProfession();
        ...
        {
            return VillagerRegistry.getById(chooseProfession(count, net.minecraftforge.fml.common.registry.VillagerRegistry.getId(prof)));
        }
        //got rid of structuretype
    ...
    public static class Well extends StructureDwarfVillagePieces.Village
    {
        public Well()
        {
        }

        public Well(StructureDwarfVillagePieces.Start start, int type, Random rand, int x, int z)
        {
            super(start, type);
        ...
        {
            StructureDwarfVillagePieces.generateAndAddRoadPiece((StructureDwarfVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.WEST, this.getComponentType());
            StructureDwarfVillagePieces.generateAndAddRoadPiece((StructureDwarfVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.EAST, this.getComponentType());
            StructureDwarfVillagePieces.generateAndAddRoadPiece((StructureDwarfVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
            StructureDwarfVillagePieces.generateAndAddRoadPiece((StructureDwarfVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
        }
    ...
    public static class Start extends StructureDwarfVillagePieces.Well
    {
        public BiomeProvider biomeProvider;
        /** World terrain type, 0 for normal, 1 for flap map */
        public int terrainType;
        public StructureDwarfVillagePieces.PieceWeight lastPlaced;
        /**
         ...
         */
        public List<StructureDwarfVillagePieces.PieceWeight> structureVillageWeightedPieceList;
        ...
        public Start(BiomeProvider biomeProviderIn, int p_i2104_2_, Random rand, int p_i2104_4_, int p_i2104_5_, List<StructureDwarfVillagePieces.PieceWeight> p_i2104_6_, int p_i2104_7_)
        {
    ...
    private static StructureComponent generateAndAddComponent(StructureDwarfVillagePieces.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        if (componentType > 50)
        {
            return null;
    ...
    private static StructureDwarfVillagePieces.Village generateComponent(StructureDwarfVillagePieces.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        ...
        else
        {
            ...
            while (j < 5)
            {
                ...
                for (StructureDwarfVillagePieces.PieceWeight structureDwarfvillagepieces$pieceweight : start.structureVillageWeightedPieceList)
                {
                    k -= structureDwarfvillagepieces$pieceweight.villagePieceWeight;

                    if (k < 0)
                    {
                        if (!structureDwarfvillagepieces$pieceweight.canSpawnMoreVillagePiecesOfType(componentType) || structureDwarfvillagepieces$pieceweight == start.lastPlaced && start.structureVillageWeightedPieceList.size() > 1)
                        {
                            break;
                        }

                        StructureDwarfVillagePieces.Village structureDwarfvillagepieces$village = findAndCreateComponentFactory(start, structureDwarfvillagepieces$pieceweight, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);

                        if (structureDwarfvillagepieces$village != null)
                        {
                            ++structureDwarfvillagepieces$pieceweight.villagePiecesSpawned;
                            start.lastPlaced = structureDwarfvillagepieces$pieceweight;

                            if (!structureDwarfvillagepieces$pieceweight.canSpawnMoreVillagePieces())
                            {
                                start.structureVillageWeightedPieceList.remove(structureDwarfvillagepieces$pieceweight);
                            }

                            return structureDwarfvillagepieces$village;
                        }
                    }
                }
            }

            StructureBoundingBox structureboundingbox = StructureDwarfVillagePieces.Torch.findPieceBox(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing);

            if (structureboundingbox != null)
            {
                return new StructureDwarfVillagePieces.Torch(start, componentType, rand, structureboundingbox, facing);
            }
            else
            {
                return null;
    ...
    public static class Torch extends StructureDwarfVillagePieces.Village
    {
        public Torch()
        {
        }

        public Torch(StructureDwarfVillagePieces.Start start, int p_i45568_2_, Random rand, StructureBoundingBox p_i45568_4_, EnumFacing facing)
        {
        ...
        public static StructureBoundingBox findPieceBox(StructureDwarfVillagePieces.Start start, List<StructureComponent> p_175856_1_, Random rand, int p_175856_3_, int p_175856_4_, int p_175856_5_, EnumFacing facing)
        {
    ...
    private static StructureDwarfVillagePieces.Village findAndCreateComponentFactory(StructureDwarfVillagePieces.Start start, StructureDwarfVillagePieces.PieceWeight weight, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        Class <? extends StructureDwarfVillagePieces.Village > oclass = weight.villagePieceClass;
        StructureDwarfVillagePieces.Village structureDwarfvillagepieces$village = null;

        if (oclass == StructureDwarfVillagePieces.House4Garden.class)
        {
            structureDwarfvillagepieces$village = StructureDwarfVillagePieces.House4Garden.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureDwarfVillagePieces.Church.class)
        {
        ...
        {
            structureDwarfvillagepieces$village = StructureDwarfVillagePieces.WoodHut.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureDwarfVillagePieces.Hall.class)
        {
            structureDwarfvillagepieces$village = StructureDwarfVillagePieces.Hall.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureDwarfVillagePieces.Field1.class)
        {
            structureDwarfvillagepieces$village = StructureDwarfVillagePieces.Field1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureDwarfVillagePieces.Field2.class)
        {
            structureDwarfvillagepieces$village = StructureDwarfVillagePieces.Field2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureDwarfVillagePieces.Forge.class)
        {
            structureDwarfvillagepieces$village = StructureDwarfVillagePieces.Forge.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureDwarfVillagePieces.House3.class)
        {
            structureDwarfvillagepieces$village = StructureDwarfVillagePieces.House3.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }

        return structureDwarfvillagepieces$village;
    }

    public static class House4Garden extends StructureDwarfVillagePieces.Village
    {
        ...
        public House4Garden(StructureDwarfVillagePieces.Start start, int p_i45566_2_, Random rand, StructureBoundingBox p_i45566_4_, EnumFacing facing)
        {
        ...
        public static StructureDwarfVillagePieces.House4Garden createPiece(StructureDwarfVillagePieces.Start start, List<StructureComponent> p_175858_1_, Random rand, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing facing, int p_175858_7_)
        {
            ...
            return StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null ? null : new StructureDwarfVillagePieces.House4Garden(start, p_175858_7_, rand, structureboundingbox, facing);
        }
    ...
    public static class Field1 extends StructureDwarfVillagePieces.Village
    {
        ...
        public Field1(StructureDwarfVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45570_4_, EnumFacing facing)
        {
            super(start, type);
            this.setCoordBaseMode(facing);
        ...
        public static StructureDwarfVillagePieces.Field1 createPiece(StructureDwarfVillagePieces.Start start, List<StructureComponent> p_175851_1_, Random rand, int p_175851_3_, int p_175851_4_, int p_175851_5_, EnumFacing facing, int p_175851_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175851_1_, structureboundingbox) == null ? new StructureDwarfVillagePieces.Field1(start, p_175851_7_, rand, structureboundingbox, facing) : null;
        }
    ...
    public static class Field2 extends StructureDwarfVillagePieces.Village
    {
        /** First crop type for this field. */
        private Block cropTypeA;
        /** Second crop type for this field. */
        ...
        public Field2(StructureDwarfVillagePieces.Start start, int p_i45569_2_, Random rand, StructureBoundingBox p_i45569_4_, EnumFacing facing)
        {
        ...
        public static StructureDwarfVillagePieces.Field2 createPiece(StructureDwarfVillagePieces.Start start, List<StructureComponent> p_175852_1_, Random rand, int p_175852_3_, int p_175852_4_, int p_175852_5_, EnumFacing facing, int p_175852_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175852_1_, structureboundingbox) == null ? new StructureDwarfVillagePieces.Field2(start, p_175852_7_, rand, structureboundingbox, facing) : null;
        }
    ...
    public static class Hall extends StructureDwarfVillagePieces.Village
    {
        public Hall()
        {
        }

        public Hall(StructureDwarfVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45567_4_, EnumFacing facing)
        {
            super(start, type);
            this.setCoordBaseMode(facing);
        ...
        public static StructureDwarfVillagePieces.Hall createPiece(StructureDwarfVillagePieces.Start start, List<StructureComponent> p_175857_1_, Random rand, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing facing, int p_175857_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175857_1_, structureboundingbox) == null ? new StructureDwarfVillagePieces.Hall(start, p_175857_7_, rand, structureboundingbox, facing) : null;
        }
    ...
    public static class WoodHut extends StructureDwarfVillagePieces.Village
    {
        ...
        public WoodHut(StructureDwarfVillagePieces.Start start, int type, Random rand, StructureBoundingBox structurebb, EnumFacing facing)
        {
            super(start, type);
            this.setCoordBaseMode(facing);
        ...
        public static StructureDwarfVillagePieces.WoodHut createPiece(StructureDwarfVillagePieces.Start start, List<StructureComponent> p_175853_1_, Random rand, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing facing, int p_175853_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175853_1_, structureboundingbox) == null ? new StructureDwarfVillagePieces.WoodHut(start, p_175853_7_, rand, structureboundingbox, facing) : null;
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 4, 0, 3, 4, 4, Blocks.DOUBLE_STONE_SLAB.getDefaultState(), Blocks.DOUBLE_STONE_SLAB.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 4, 1, 2, 4, 3, Blocks.STONE_SLAB.getDefaultState().withProperty(BlockStoneSlab.VARIANT,BlockStoneSlab.EnumType.SMOOTHBRICK), Blocks.STONE_SLAB.getDefaultState().withProperty(BlockStoneSlab.VARIANT,BlockStoneSlab.EnumType.SMOOTHBRICK), false);
    ...
    public static class Church extends StructureDwarfVillagePieces.Village
    {
        public Church()
        {
        }

        public Church(StructureDwarfVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45564_4_, EnumFacing facing)
        {
            super(start, type);
            this.setCoordBaseMode(facing);
        ...
        public static StructureDwarfVillagePieces.Church createPiece(StructureDwarfVillagePieces.Start start, List<StructureComponent> p_175854_1_, Random rand, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing facing, int p_175854_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175854_1_, structureboundingbox) == null ? new StructureDwarfVillagePieces.Church(start, p_175854_7_, rand, structureboundingbox, facing) : null;
        }
    ...
    public static class Forge extends StructureDwarfVillagePieces.Village
    {
        ...
        public Forge(StructureDwarfVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45563_4_, EnumFacing facing)
        {
            super(start, type);
            this.setCoordBaseMode(facing);
        ...
        public static StructureDwarfVillagePieces.Forge createPiece(StructureDwarfVillagePieces.Start start, List<StructureComponent> p_175855_1_, Random rand, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing facing, int p_175855_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175855_1_, structureboundingbox) == null ? new StructureDwarfVillagePieces.Forge(start, p_175855_7_, rand, structureboundingbox, facing) : null;
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            IBlockState iblockstate = Blocks.STONE.getDefaultState().withProperty(BlockStone.VARIANT,BlockStone.EnumType.ANDESITE_SMOOTH);
            IBlockState iblockstate1 = this.getBiomeSpecificBlockState(Blocks.OAK_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.NORTH));
            ...
            this.setBlockState(worldIn, Blocks.ANVIL.getDefaultState(), 8, 1, 1, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.GLASS_PANE.getDefaultState(), 0, 2, 2, structureBoundingBoxIn);
    ...
    private static StructureComponent generateAndAddRoadPiece(StructureDwarfVillagePieces.Start start, List<StructureComponent> p_176069_1_, Random rand, int p_176069_3_, int p_176069_4_, int p_176069_5_, EnumFacing facing, int p_176069_7_)
    {
        ...
        {
            StructureBoundingBox structureboundingbox = StructureDwarfVillagePieces.Path.findPieceBox(start, p_176069_1_, rand, p_176069_3_, p_176069_4_, p_176069_5_, facing);

            if (structureboundingbox != null && structureboundingbox.minY > 10)
            {
                StructureComponent structurecomponent = new StructureDwarfVillagePieces.Path(start, p_176069_7_, rand, structureboundingbox, facing);
    ...
    public abstract static class Road extends StructureDwarfVillagePieces.Village
    {
        public Road()
        {
        }

        protected Road(StructureDwarfVillagePieces.Start start, int type)
        {
            super(start, type);
        }
    }

    public static class Path extends StructureDwarfVillagePieces.Road
    {
        private int length;
        ...
        public Path(StructureDwarfVillagePieces.Start start, int p_i45562_2_, Random rand, StructureBoundingBox p_i45562_4_, EnumFacing facing)
        {
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            ...
            {
                StructureComponent structurecomponent = this.getNextComponentNN((StructureDwarfVillagePieces.Start)componentIn, listIn, rand, 0, i);
            ...
            {
                StructureComponent structurecomponent1 = this.getNextComponentPP((StructureDwarfVillagePieces.Start)componentIn, listIn, rand, 0, j);
            ...
            if (flag && rand.nextInt(3) > 0 && enumfacing != null)
            {
                switch (enumfacing)
                {
                    case NORTH:
                    default:
                        StructureDwarfVillagePieces.generateAndAddRoadPiece((StructureDwarfVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, this.getComponentType());
                        break;
                    case SOUTH:
                        StructureDwarfVillagePieces.generateAndAddRoadPiece((StructureDwarfVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.WEST, this.getComponentType());
                        break;
                    case WEST:
                        StructureDwarfVillagePieces.generateAndAddRoadPiece((StructureDwarfVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                        break;
                    case EAST:
                        StructureDwarfVillagePieces.generateAndAddRoadPiece((StructureDwarfVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                }
            }
            ...
            if (flag && rand.nextInt(3) > 0 && enumfacing != null)
            {
                switch (enumfacing)
                {
                    case NORTH:
                    default:
                        StructureDwarfVillagePieces.generateAndAddRoadPiece((StructureDwarfVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, this.getComponentType());
                        break;
                    case SOUTH:
                        StructureDwarfVillagePieces.generateAndAddRoadPiece((StructureDwarfVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.EAST, this.getComponentType());
                        break;
                    case WEST:
                        StructureDwarfVillagePieces.generateAndAddRoadPiece((StructureDwarfVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                        break;
                    case EAST:
                        StructureDwarfVillagePieces.generateAndAddRoadPiece((StructureDwarfVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                }
            }
        }

        public static StructureBoundingBox findPieceBox(StructureDwarfVillagePieces.Start start, List<StructureComponent> p_175848_1_, Random rand, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing facing)
        {
    ...
    public static class House3 extends StructureDwarfVillagePieces.Village
    {
        public House3()
        {
        }

        public House3(StructureDwarfVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45561_4_, EnumFacing facing)
        {
            super(start, type);
            this.setCoordBaseMode(facing);
        ...
        public static StructureDwarfVillagePieces.House3 createPiece(StructureDwarfVillagePieces.Start start, List<StructureComponent> p_175849_1_, Random rand, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing facing, int p_175849_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175849_1_, structureboundingbox) == null ? new StructureDwarfVillagePieces.House3(start, p_175849_7_, rand, structureboundingbox, facing) : null;
        }
